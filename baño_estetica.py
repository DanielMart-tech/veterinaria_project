...
4- Finish Service.")
                    choice_3= int (input(': '))
                    if choice_3 == 1:
                        print (f'You have selected, cut nails.')
                        return
                    elif choice_3 == 2:
                        print (f'You have selected, cut hair.')
                        return
                    elif choice_3 == 3:
                        print (f'You have selected, pait nails.')
                        return
                    elif choice_3 == 4:
                        print (f'Okay, thanks for coming today!')
                        return 
                    else:
                        print (f'Select a correct option...') 
